...
class WaveView extends StatefulWidget {
  final double lifepoint;

  const WaveView({Key? key, this.lifepoint = 35.0}) : super(key: key);
  @override
            ...
            new ClipPath(
              child: new Container(
                decoration: BoxDecoration(
                  color: CompanionAppTheme.defeatRed.withOpacity(0.5),
                  ...
                  gradient: LinearGradient(
                    colors: [
                      CompanionAppTheme.defeatRed.withOpacity(0.2),
                      CompanionAppTheme.defeatRed.withOpacity(0.5)
                    ],
            ...
            new ClipPath(
              child: new Container(
                decoration: BoxDecoration(
                  ...
                  gradient: LinearGradient(
                    colors: [
                      CompanionAppTheme.defeatRed.withOpacity(0.4),
            ...
            Padding(
              ...
              child: Center(
                child: Row(
                  ...
                  children: <Widget>[
                    Text(
                      widget.lifepoint.round().toString(),
                      ...
                      style: TextStyle(
                        ...
                        fontSize: 24,
                        letterSpacing: 0.0,
                        color: CompanionAppTheme.darkText,
                      ),
                    ),
                  ],
                ),
            ...
            Positioned(
              ...
              child: new ScaleTransition(
                ...
                child: Container(
                  ...
                  height: 2,
                  decoration: BoxDecoration(
                    color: CompanionAppTheme.white.withOpacity(0.4),
            ...
            Positioned(
              ...
              child: new Transform(
                ...
                child: Container(
                  ...
                  height: 4,
                  decoration: BoxDecoration(
                    color: CompanionAppTheme.white.withOpacity(
